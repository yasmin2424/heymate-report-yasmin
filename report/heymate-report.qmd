...
![Flow chart](../image/1_visual_flow.png){width="80%" fig-align="center"}


The recommender system operates through the following four steps as shown in the flow chart above:
